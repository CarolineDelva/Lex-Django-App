...
from approject.approject.DataPreparation import PrepareData, InitEmbedings
from approject.approject.cosinesimilarity import cosine_similarity
import pandas as pd 
import hashlib
...
class ComputeSimilarities(luigi.Task):
    ...
    n_similar = luigi.IntParameter(default=10)
